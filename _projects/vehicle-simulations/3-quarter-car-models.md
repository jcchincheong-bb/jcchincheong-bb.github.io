...
![Simulink Model for Quarter Car with Road Excitation](/assets/image-19.png)
...
![200 kg less](/assets/image-23.png)

200 kg less

![40000 N/m more](/assets/image-24.png)

40000 N/m more

![3000 damping more](/assets/image-25.png)

3000 damping more

![400000 spring 3000 damping](/assets/image-26.png)

400000 spring 3000 damping

![10 stiffness](/assets/image-27.png)

10 stiffness

![15 damping](/assets/image-28.png)

15 damping

### 3.0.2.1 Observations from Frequency Modification

![with the integrator](/assets/image-29.png)

with the integrator

![with the derivative](/assets/image-30.png)

with the derivative

![image.png](/assets/image-31.png)

![2 rad/s](/assets/image-32.png)

2 rad/s

![3 rad/s](/assets/image-33.png)

3 rad/s

![4 rad/s](/assets/image-34.png)

4 rad/s

![5 rad/s](/assets/image-35.png)

5 rad/s

![6 rad/s](/assets/image-36.png)

6 rad/s

![7 rad/s](/assets/image-37.png)

7 rad/s

![7.071 rad/s Natural frequency ](/assets/image-38.png)

7.071 rad/s Natural frequency 

![8 rad/s](/assets/image-39.png)

8 rad/s

![9 rad/s](/assets/image-40.png)

9 rad/s

![10 rad/s](/assets/image-41.png)

10 rad/s

![10 rad/s](/assets/image-42.png)

10 rad/s

![2, 4, 6, 8, 10 Hz](/assets/image-43.png)

2, 4, 6, 8, 10 Hz

![2 Hz](/assets/image-44.png)

2 Hz

![5 Hz](/assets/image-45.png)

5 Hz

![8 Hz](/assets/image-46.png)

8 Hz

![10 Hz](/assets/image-47.png)

10 Hz

![2 Hz, 5s](/assets/image-48.png)

2 Hz, 5s

![5 Hz, 5s](/assets/image-49.png)

5 Hz, 5s

![8 Hz, 5 secs](/assets/image-50.png)

8 Hz, 5 secs

![10 Hz, 5 s](/assets/image-51.png)

10 Hz, 5 s

![100 Hz](/assets/image-52.png)

### 3.0.2.2 Frequency Domain Characteristics

![From using Simulink ](/assets/image-53.png)

From using Simulink 

![From using bode()](/assets/image-54.png)

From using bode()

![Psuedo Bode Plot of Amplitude (z [m] vs w [rad/s] )](/assets/image-55.png)

Psuedo Bode Plot of Amplitude (z [m] vs w [rad/s] )

![Pseudo Bode Plot of Phase ](/assets/image-56.png)
